...
public class Hacker {
    ...
    public static final RegistryObject<Item> programblock_item = ITEMS.register("program_block", () -> new BlockItem(programblock.get(), new Item.Properties().rarity(Rarity.EPIC)));
